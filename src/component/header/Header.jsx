          ...
          <div className='nav-header d-flex justify-content-between'>
            <div className='d-flex'>
              <div className='user-img'>
                <Link to='/'><img src='https://img.lovepik.com/free-png/20211204/lovepik-cartoon-avatar-png-image_401302777_wh1200.png' alt='' /></Link>
              </div>
              <div className='user-info'>
                <span><b>John Wick</b></span>
                <p>Lái xe</p>
              </div>
            </div>
            <div className='nav-icon'>
              <i class="fa-solid fa-bars col-4"
                onClick={() => setToggle(!toggle)}
              ></i>
            </div>
          </div>
